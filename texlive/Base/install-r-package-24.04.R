...
if (!requireNamespace("remotes", quietly = TRUE))
  install.packages("remotes", repos="https://packagemanager.posit.co/cran/2024-03-16")
...
if (!requireNamespace("BiocManager", quietly = TRUE))
  remotes::install_version(
    "BiocManager",
    version = "1.30.22",
    repos = "https://packagemanager.posit.co/cran/2024-03-16",
...
repo <- "https://packagemanager.posit.co/cran/2024-03-16"
